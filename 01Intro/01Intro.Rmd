...
- Welcome to the AMSI Winter School course on dimension reduction!
--

- The course is made up of 10 "lectures" each taking about roughly 30-40 minutes.
--

- All materials are available on a [github repository](https://github.com/anastasiospanagiotelis/DimensionReduction).
--

- During the course we will communicate over the slack channel.
--

- If you want to contact me after the Winter School you can find my details on my [personal website](https://anastasiospanagiotelis.netlify.app/).
